...
*/
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function appendProps(source, predicate, newProps) {
                ...
                var processObject = function (item) {
                    ...
                    Object.keys(itemClone).forEach(function (key) {
                        ...
                        if (helpers_1.isObject(itemClone[key]) || Array.isArray(itemClone[key])) {
                            itemClone = __assign(
                                __assign({}, itemClone),
                                ((_a = {}), (_a[key] = appendProps(itemClone[key], predicate, newProps)), _a),
                            );
                        }
                    });
                    return itemClone;
                ...
                if (
                    (Array.isArray(source) || helpers_1.isObject(source)) &&
                    !helpers_1.isEmpty(predicate) &&
                    !helpers_1.isEmpty(newProps)
                ) {
                ...
                var processObject = function (item) {
                    ...
                    Object.keys(itemClone).forEach(function (key) {
                        ...
                        if (helpers_1.isObject(itemClone[key]) || Array.isArray(itemClone[key])) {
                            itemClone = __assign(
                                __assign({}, itemClone),
                                ((_a = {}), (_a[key] = replaceObject(itemClone[key], predicate, replaceWith)), _a),
                            );
                        }
                    });
                    return itemClone;
            ...
            function changeProps(source, predicate, replaceProps) {
                ...
                var processObject = function (item) {
                    ...
                    Object.keys(itemClone).forEach(function (key) {
                        ...
                        if (helpers_1.isObject(itemClone[key]) || Array.isArray(itemClone[key])) {
                            itemClone = __assign(
                                __assign({}, itemClone),
                                ((_a = {}), (_a[key] = changeProps(itemClone[key], predicate, replaceProps)), _a),
                            );
                        }
                    });
                    return itemClone;
                ...
                if (
                    (Array.isArray(source) || helpers_1.isObject(source)) &&
                    !helpers_1.isEmpty(predicate) &&
                    !helpers_1.isEmpty(replaceProps)
                ) {
                    return !Array.isArray(source)
                        ? processObject(source)
                        : source.map(function (item) {
                ...
                var processObject = function (item) {
                    ...
                    Object.keys(itemClone).forEach(function (key) {
                        ...
                        if (helpers_1.isObject(itemClone[key]) || Array.isArray(itemClone[key])) {
                            itemClone = __assign(
                                __assign({}, itemClone),
                                ((_a = {}), (_a[key] = removeObject(itemClone[key], predicate)), _a),
                            );
                        }
                    });
                    return itemClone;
            ...
            function insertObject(source, predicate, objectToInsert, isBefore) {
                    ...
                    Object.keys(itemClone).forEach(function (key) {
                        ...
                        if (helpers_1.isObject(itemClone[key]) || Array.isArray(itemClone[key])) {
                            itemClone = __assign(
                                __assign({}, itemClone),
                                ((_a = {}),
                                (_a[key] = insertObject(itemClone[key], predicate, objectToInsert, isBefore)),
                                _a),
                            );
                        }
                    });
                ...
                if (
                    (Array.isArray(source) || helpers_1.isObject(source)) &&
                    !helpers_1.isEmpty(predicate) &&
                    !helpers_1.isEmpty(objectToInsert)
                ) {
                ...
                return /******/ (function (modules) {
                    ...
                    /******/ [
                        ...
                        /***/ function (module, __webpack_exports__, __webpack_require__) {
                            ...
                            /* harmony default export */ var clipboard = (__webpack_exports__["default"] =
                                clipboard_Clipboard);
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            exports.checkAgainstPredicate = function (sourceItem, predicate) {
                return (
                    exports.isObject(sourceItem) &&
                    exports.isObject(predicate) &&
                    Object.keys(predicate).every(function (key) {
                        return (
                            Object.prototype.hasOwnProperty.call(sourceItem, key) && predicate[key] === sourceItem[key]
                        );
                    })
                );
            };
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
            ...
            var templates_createFieldsetCategory = function createFieldsetCategory(id, typeOfCategory, data) {
                ...
                return concat_default()(
                    (_context = concat_default()(
                        (_context2 = concat_default()(
                            (_context3 = concat_default()(
                                ...
                                ).call(_context5, typeOfCategory, '" \n          ')),
                            ).call(
                                _context4,
                                data !== undefined ? 'value="'.concat(data.name, '"') : "",
                                ' required>\n        </label>\n        <label class="data-maker__field-wrap">\n          <h3 class="data-maker__name-field data-maker__name-field--new-line">\n            \u041A\u0430\u0440\u0442\u0438\u043D\u043A\u0430 ',
                            )),
                        ).call(
                            _context3,
                            typeOfCategory,
                            ' <span>(\u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043A\u0430\u0440\u0442\u0438\u043D\u043A\u0438 \u0438\u0437 \u0440\u0435\u0434\u0430\u043A\u0442\u043E\u0440\u0430)</span>\n          </h3>\n          <input class="data-maker__input data-maker__input--img" type="text" name="img-category-id-',
                        )),
                    ).call(
                        _context2,
                        id,
                    ...
                    _context,
                    data !== undefined ? 'value="'.concat(data.img, '"') : "",
            ...
            var templates_createFieldsetProduct = function createFieldsetProduct(id, data) {
                ...
                return concat_default()(
                    (_context9 = concat_default()(
                        (_context10 = concat_default()(
                            (_context11 = concat_default()(
                                (_context12 = concat_default()(
                                    (_context13 = concat_default()(
                                        (_context14 = concat_default()(
                                            (_context15 = concat_default()(
                                                (_context16 = '\n    <fieldset id="'.concat(
                                                    id,
                                                    '" class="data-maker__fields data-maker__fields--product">\n      <div class="data-maker__fields-top">\n        <h2 class="data-maker__fields-title">\n          ',
                                                )),
                                            ).call(
                                                _context16,
                                                data !== undefined
                                                    ? "".concat(data.name)
                                                    : "\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u0442\u043E\u0432\u0430\u0440\u0430",
                                                '\n        </h2>\n        <div class="data-maker__hide-btn">\u0421\u043A\u0440\u044B\u0442\u044C</div>\n        <div class="data-maker__delete-btn data-maker__delete-btn--fields"></div>   \n      </div>\n      <div class="data-maker__fields-content">\n        <div class="data-maker__field-wrap">\n          <h3 class="data-maker__name-field">\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0442\u043E\u0432\u0430\u0440\u0430 *</h3>\n          <input class="data-maker__input data-maker__input--name" type="text" name="name-product-id-',
                                            )),
                                        ).call(
                                            _context15,
                                            id,
                            ...
                            _context11,
                            data !== undefined ? 'value="'.concat(data.img, '"') : "",
                            '>\n        </label>\n        <label class="data-maker__field-wrap">\n          <h3 class="data-maker__name-field">\u0426\u0435\u043D\u0430 \u0442\u043E\u0432\u0430\u0440\u0430 *</h3>\n          <input class="data-maker__input data-maker__input--price-product" type="number" name="price-product-id-',
                        )),
                    ).call(
                        _context10,
                        id,
                    ...
                    _context9,
                    data !== undefined ? 'value="'.concat(data.price, '"') : "",
            ...
            var templates_createOption = function createOption(id, numberOption, state) {
                ...
                return concat_default()(
                    (_context18 = concat_default()(
                        (_context19 = concat_default()(
                            (_context20 = concat_default()(
                                (_context21 = concat_default()(
                                    (_context22 = concat_default()(
                                        (_context23 =
                                            '\n    <div class="data-maker__option-item">\n      <label class="data-maker__option-field-wrap">\n        <h4 class="data-maker__name-field">\u041E\u043F\u0446\u0438\u044F <span class="data-maker__option-num">'.concat(
                                                numberOption,
                                        ...
                                        '-product" type="text" name="option-',
                                    )),
                                ).call(_context22, numberOption, "-product-id-")),
                            ).call(
                                _context21,
                                id,
                            ...
                            state !== undefined
                                ? 'value="'.concat(
                                      map_default()(state).call(state, function (_ref) {
                        ...
                        state !== undefined
                            ? 'value="'.concat(
                                  map_default()(state).call(state, function (_ref3) {
                    ...
                    _context18,
                    state !== undefined
                        ? map_default()(state).call(state, function (_ref5) {
            ...
            var templates_createOptionWrap = function createOptionWrap(id, state) {
                ...
                return concat_default()(
                    (_context24 = concat_default()(
                        (_context25 =
                            '\n    <div class="data-maker__option-wrap">\n      <label class="data-maker__field-wrap">\n        <div class="data-maker__fields-top">\n          <h3 class="data-maker__name-field">\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0433\u0440\u0443\u043F\u043F\u044B \u043E\u043F\u0446\u0438\u0439</h3>\n          <div class="data-maker__delete-btn data-maker__delete-btn--option"></div>\n        </div>\n        <input class="data-maker__input data-maker__input--option-list-name" type="text" name="option-title-product-id-'.concat(
                                id,
                                '" placeholder="\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043E\u043F\u0446\u0438\u0438" required\n        ',
                            )),
                    ).call(
                        _context25,
                        state !== undefined ? 'value="'.concat(state.nameOptionList, '"') : "",
                        '>\n      </label>\n      <div class="data-maker__option">\n      ',
                    )),
                ).call(
                    _context24,
                    state !== undefined
                        ? map_default()((_context26 = state.optionList))
                              .call(_context26, function (item, index) {
                                  return templates_createOption(id, index + 1, entries_default()(item));
                              })
                              .join("")
                        : templates_createOption(id, 1),
                ...
                var newTree = function newTree(arr, firstLevel, secondLevel, indexItem) {
                    map_default()(arr).call(arr, function (item) {
                        ...
                        if (firstLevel in item === false && secondLevel in item === false) {
                            ...
                            var desc =
                                    item.desc !== undefined
                                        ? templates_createProductDesc(item.id, item.desc.replace(/<br\s*[/]?>/gi, "\n"))
                                        : "",
                                option =
                                    item.options !== undefined ? templates_createOptionWrap(item.id, item.options) : ""; // Ищем родительскую категорию
                            ...
                            var newCategory = templates_createFieldsetCategory(
                                item.id,
                                "\u043F\u043E\u0434\u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0438",
                                item,
                            );
                            ...
                            if (_parentCategory2 !== null) {
                                ...
                                _newCategory = templates_createFieldsetCategory(
                                    item.id,
                                    "\u043F\u043E\u0434\u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0438",
                                    item,
                                );
            ...
            var utils_indexOfLastElement = function indexOfLastElement(parentNode, className) {
                ...
                var lastElement = filter_default()((_context = toConsumableArray_default()(parentNode.children))).call(
                    _context,
                    function (e) {
  ...
  */
              ...
              */
                                    var newItem = filter_default()((_context2 = item[secondLevel])).call(
                                        _context2,
                                        function (item) {
    ...
    */
            ...
            function _unsupportedIterableToArray(o, minLen) {
                ...
                var n = slice_default()((_context7 = Object.prototype.toString.call(o))).call(_context7, 8, -1);
                if (n === "Object" && o.constructor) n = o.constructor.name;
            ...
            var data_maker_addElementOnEntryLevel = function addElementOnEntryLevel(type, elementInsert) {
                ...
                if (type === "product") {
                    ...
                    typeOfFields = templates_createFieldsetCategory(
                        data_maker_id,
                        "\u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0438",
                    );
                }
            ...
            var data_maker_addProduct = function addProduct(target, parentNode, data) {
                ...
                var productToCatBtn = filter_default()(
                    (_context = toConsumableArray_default()(parentNode.children)),
            ...
            var data_maker_addCategory = function addCategory(target, parentNode, data) {
                ...
                var subCategoryBtn = filter_default()(
                    (_context2 = toConsumableArray_default()(parentNode.children)),
                ).call(_context2, function (e) {
                ...
                if (subCategoryBtn === target) {
                    ...
                    subCategoryBtn.insertAdjacentHTML(
                        "beforebegin",
                        templates_createFieldsetCategory(
                            data_maker_id,
                            "\u043F\u043E\u0434\u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0438",
                        ),
                    );
                ...
                if (wrapOption !== null) {
                    ...
                    if (addOptionHandler === target) {
                        ...
                        data.options.optionList.push(
                            ((_data$options$optionL = {}),
                            defineProperty_default()(_data$options$optionL, "optionName" + lastOptionNum, true),
                            defineProperty_default()(_data$options$optionL, "price", Number(priceProduct.value)),
                            _data$options$optionL),
                        );
            ...
            var inputAddValue = function inputAddValue(
                inputFieldParent,
                currentInput,
                currentChangeObject,
                changeValue,
            ...
            var data_maker_addInputEvent = function addInputEvent() {
                ...
                for_each_default()(allInputs).call(allInputs, function (input) {
                    input.oninput = utils_debounce(function (target) {
                        ...
                        var inputFieldParent = find_default()((_context3 = target.path)).call(
                            _context3,
                            function (item) {
                        ...
                        if (inputFieldParent.classList.contains("data-maker__fields--product")) {
                            ...
                            if (productOptionsWrap !== null) {
                                // Ищем название опций
                                var inputProductOptionsName = productOptionsWrap.querySelector(
                                ...
                                var inputProductOptionName =
                                    productOptionsWrap.querySelectorAll(".data-maker__option-item"); // Проходим по коллекции опций
                                ...
                                try {
                                    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                                        ...
                                        if (input === inputOptionName) {
                                            ...
                                            productList = lib["replaceObject"](
                                                productList,
                                                option,
                                                ((_findAnd$replaceObjec = {}),
                                                defineProperty_default()(
                                                    _findAnd$replaceObjec,
                                                    input.value,
                                                    inputOptionStatus.checked,
                                                ),
                                                defineProperty_default()(
                                                    _findAnd$replaceObjec,
                                                    "price",
                                                    Number(inputOptionPrice.value),
                                                ),
                                                _findAnd$replaceObjec),
                                            );
            ...
            var data_maker_createStructure = function createStructure() {
                ...
                if (fieldsWrap !== null) {
                    ...
                    if (deleteFieldsBtn === target) {
                        ...
                        var addSubcategoryBtn = function addSubcategoryBtn(type, name) {
                            ...
                            return concat_default()(
                                (_context4 = '<div class="data-maker__add data-maker__add--'.concat(
                                    type,
                                    '" tabindex="0">\n        + \u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C ',
                                )),
                            ).call(_context4, name, "\n      </div>");
                        ...
                        var parentProductBtn = filter_default()(
                            (_context5 = toConsumableArray_default()(fieldsWrap.parentNode.children)),
                        ).call(_context5, function (el) {
                            return el.classList.contains("data-maker__add--product");
                        ...
                        if (parentProductBtn === undefined && fieldsWrap.parentNode !== formWrap) {
                            ...
                            var subcategoryBtn = filter_default()(
                                (_context6 = toConsumableArray_default()(fieldsWrap.parentNode.children)),
                            ).call(_context6, function (el) {
                ...
                if (submitBtn === target) {
                    ...
                    if (formWrap.checkValidity() && productList.length === 0) {
                        var _message =
                            '<span class="message-to-create">\u041C\u043E\u0436\u0435\u0442 \u0431\u044B\u0442\u044C \u043D\u0443\u0436\u043D\u043E \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0442\u043E\u0432\u0430\u0440 \u0438\u043B\u0438 \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044E?</span>';
            ...
            copyInfo.on("success", function (e) {
                e.trigger.textContent =
                    "\u0421\u043A\u043E\u043F\u0438\u0440\u043E\u0432\u0430\u043D\u043E! \u0412\u0441\u0442\u0430\u0432\u044C\u0442\u0435 \u044D\u0442\u043E\u0442 \u0442\u0435\u043A\u0441\u0442 \u043F\u043E\u0441\u043B\u0435 \u043A\u043E\u0434\u0430 \u043C\u0430\u0433\u0430\u0437\u0438\u043D\u0430";
                e.clearSelection();
