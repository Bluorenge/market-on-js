...
const inputFindProduct = (arr, nameFromInput) => {
    ...
    const findProduct = (arr, searchName) => {
        if (arr !== undefined) {
          ...
          */
                    let newItem = item.productsInCategory.filter(item => item.name.toLowerCase().includes(searchName));
        ...
        if (element.offsetWidth < width) {
            ...
            if (horizontal) {
                ...
                const checkScrollY = element => {
                    let maxScrollLeft = carouselWrap.scrollWidth - carouselWrap.clientWidth;
                ...
                const checkScrollX = element => {
                    let maxScrollBottom = carouselWrap.scrollHeight - carouselWrap.clientHeight;
...
export { findByName, inputFindProduct, menuPath, debounce, elementReady, carousel, carouselNav, addScrollBar };
