      ...
      <div class="market-products__product-bottom">
        ${
            item.price !== undefined
                ? `<span class="market-products__product-price">${item.price.toLocaleString(`ru-RU`)} ${
...
const createProductPage = (productObject, globalSetting, contentId) => {
    ...
    const productPage = `<section class="market-product market-content--fade-in">
      ...
      <div class="market-product__img-wrap">
        <img src="https://media.lpgenerator.ru/images/${globalSetting.userId}/${productObject.img}" alt="product-img">
      </div>
      <div class="market-product__content-wrap">
        ${
            `options` in productObject && productObject.options !== undefined
                ...
                <div class="market-product__option-title">${productObject.options.nameOptionList}:</div>
        ...
        <div class="market-product__price-wrap">
          <span>Стоимость: </span>
          <span class="market-product__price">${productObject.price.toLocaleString(`ru-RU`)}</span>
      ...
      ${productObject
        ...
        <div class="market-cart__product-content">  
          <div class="market-cart__img-wrap">
            <img src="https://media.lpgenerator.ru/images/${globalSetting.userId}/${item.img}" alt="">
          </div>
          ...
          <div class="market-cart__desc-wrap">
            <div class="market-cart__product-price-wrap">
              ...
              <span class="market-cart__product-total-price-wrap">
                <span class="market-cart__product-total-price">${item.price * item.quantity}</span>
                <span> ${globalSetting.currency}</span>
              </span>
            ...
            <div class="market-cart__quantity-wrap">
              ...
              <div class="market-cart__quantity-field">
                ...
                <input type="text" pattern="[0-9]" value="${item.quantity}" class="market-cart__quantity-input">
    ...
    if (productObject.length > 0) {
      ...
      <div class="market-cart-link__text-row">
        <span class="market-cart-link__price">${
            productObject.reduce((total, item) => total + item.price * item.quantity, 0).toLocaleString(`ru-RU`) +
            ` ` +
            globalSetting.currency
        }</span>
      </div>
...
export { createNavItem, createProductList, createProductPage, createCartPage, createCartBlock };
