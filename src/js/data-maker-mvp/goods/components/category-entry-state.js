...
export default class CategoryEntryStateComponent extends AbstractComponent {
    ...
    setAddProductBtnHandler(handler) {
        this.getElement.querySelector(".data-maker__btn-add--product-category").addEventListener("click", handler);
    }

    setAddSubCategoryBtnHandler(handler) {
        this.getElement.querySelector(".data-maker__btn-add--subcategory").addEventListener("click", handler);
    }
}
