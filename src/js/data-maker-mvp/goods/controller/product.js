...
export default class ProductController {
    ...
    render() {
        ...
        render(this._productComponent.getElement(), this._addOptionsBtnComponent, RenderPosition.BEFOREEND);
    ...
    _getData() {
        ...
        const optionsData = this._optionListController ? { options: this._optionListController.getData() } : undefined;
