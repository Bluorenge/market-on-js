export const newProductCart = (product, productPrice, optionName, optionValue) => {
...
export const newProductCartArr = (productArr, newProduct, quantityUp = true) => {
...
export const isItProductInCart = (cart, productName) => cart.some(product => product.name === productName);
